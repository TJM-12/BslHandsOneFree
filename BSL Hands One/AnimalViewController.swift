...
class AnimalViewController: UIViewController, UIScrollViewDelegate, GADBannerViewDelegate {
    ...
    @IBAction func farmAction(_ sender: Any) {
        playVideo(url: "http://www.discoverycamp.co.uk/BT_Video/AnimalsFarm.mp4")
    }
    
    @IBAction func petAction(_ sender: Any) {
        playVideo(url: "http://www.discoverycamp.co.uk/BT_Video/AnimalsPet.mp4")
    }
    @IBAction func jungleAction(_ sender: Any) {
        playVideo(url: "http://www.discoverycamp.co.uk/BT_Video/AnimalsJungle.mp4")
    }
    
    @IBAction func underseaAction(_ sender: Any) {
        playVideo(url: "http://www.discoverycamp.co.uk/BT_Video/AnimalsSea.mp4")
    }
